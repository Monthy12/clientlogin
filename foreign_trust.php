                                    ...
                                    <div class="row">
                                            ...
                                            <div class="row mt-4">
                                                    ...
                                                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                                                        <ol class="breadcrumb">
                                                            <li class="breadcrumb-item mr-2 pb-4"><a href="foreign_trust.php"> 3520 Foreign Trust</a></li>
                                                    ...
                                                    <div class="col-md-2 offset-md-6">
                                                        <div class="row mr-auro">
                                                            <div class="d-flex ">
                                                                ...
                                                                <div class="mr-5">
                                                                    <a href="#" class="btn btn-outline-warning color-text-white my-5 mx-5 ml-5">
                                                                        <span class="pl-0 button_font_small">Summary <i class="fas fa-arrow-right button_font_small"></i></span>
                                                                    </a>
                                                                </div>
